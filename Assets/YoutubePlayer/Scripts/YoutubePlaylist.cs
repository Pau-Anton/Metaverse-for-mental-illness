...
namespace YoutubePlayer
{
    public class YoutubePlaylist : MonoBehaviour
    {
        ...
        public async void StartPlaylistPlayer()
        {
            PlaylistTitle.text="Loading playlist...";
            ...
            foreach (var entry in playList.Entries)
            {
                ...
                async void OnItemClicked()
                {
                    ...
                    //playerObject.GetComponentInChildren<BoxCollider>().OnTriggerExit.AddListener(OnCloseButtonClicked);
